...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Fig/block_diagram_small.png}
...
\begin{itemize}
    \item \textbf{Sampling Rate}: Input USRP rate of 256 kHz (\texttt{QUAD\_RATE}), decimated by 8 to 32 kHz (\texttt{AUDIO\_RATE}) for audio output.
    \item \textbf{Quantization}: 10-bit fixed-point precision (\texttt{QUANT\_VAL = 1024}), using Q10 format for all internal arithmetic.
